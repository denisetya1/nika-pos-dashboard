...
export const getRealtimeSummary = async () => {
  ...
  //     createdAt: {
  //       gte: new Date(
  //         `${moment().subtract(1, "day").format("yy-MM-DD")} 00:00:00`,
  //       ),
  ...
  //     createdAt: {
  //       gte: new Date(
  //         `${moment().subtract(2, "days").format("yy-MM-DD")} 00:00:00`,
  //       ),
  //       lte: new Date(
  //         `${moment().subtract(2, "days").format("yy-MM-DD")} 23:59:59`,
  //       ),
  //     },
  //     outletPaymentMethod: {
  //       paymentMethodId: {
  ...
  //     createdAt: {
  //       gte: new Date(
  //         `${moment().subtract(3, "days").format("yy-MM-DD")} 00:00:00`,
  //       ),
  //       lte: new Date(
  //         `${moment().subtract(3, "days").format("yy-MM-DD")} 23:59:59`,
  //       ),
  //     },
  //     outletPaymentMethod: {
  //       paymentMethodId: {
  ...
  //     createdAt: {
  //       gte: new Date(
  //         `${moment().subtract(4, "days").format("yy-MM-DD")} 00:00:00`,
  //       ),
  //       lte: new Date(
  //         `${moment().subtract(4, "days").format("yy-MM-DD")} 23:59:59`,
  //       ),
  //     },
  //     outletPaymentMethod: {
  //       paymentMethodId: {
  ...
  //     createdAt: {
  //       gte: new Date(
  //         `${moment().subtract(5, "days").format("yy-MM-DD")} 00:00:00`,
  //       ),
  //       lte: new Date(
  //         `${moment().subtract(5, "days").format("yy-MM-DD")} 23:59:59`,
  //       ),
  //     },
  //     outletPaymentMethod: {
  //       paymentMethodId: {
  ...
  //     createdAt: {
  //       gte: new Date(
  //         `${moment().subtract(6, "days").format("yy-MM-DD")} 00:00:00`,
  //       ),
  //       lte: new Date(
  //         `${moment().subtract(6, "days").format("yy-MM-DD")} 23:59:59`,
  //       ),
  //     },
  //     outletPaymentMethod: {
  //       paymentMethodId: {
